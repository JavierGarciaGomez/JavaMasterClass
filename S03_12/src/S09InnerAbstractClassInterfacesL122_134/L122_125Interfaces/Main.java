...
public class Main {
    public static void main(String[] args) {
        /* 122. Interfaces
         * interfaces gives a common behavior
         * With an interface the methos implemented wont change*/

        ITelephone iTelephone = new DeskPhone(4321);
        ...
        iTelephone = new MobilePhone();
        iTelephone.callPhone(243);
        iTelephone.answer();
        ...
        * */
        System.out.println("**************124. Challenge *******************");
        ...
        // We cant access to the methods of Monster because we created it as an interface, but we can cast it
