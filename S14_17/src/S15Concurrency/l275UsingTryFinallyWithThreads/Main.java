package S15Concurrency.l275UsingTryFinallyWithThreads;
...
/*275
    SUMMARY
        -try finally with locks
        -tryLock()

    NOTES
        -We weren't using locks in the recommended way.

    CODE
        -1 change for finally
        -6tryLock() and counter
